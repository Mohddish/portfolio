...
export default function Home() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      id: 9,
      title: "Essentialist",
      description: "A minimalist approach to life and creativity",
      videoUrl: "https://www.youtube.com/embed/yihzD2UKNnA?autoplay=1&mute=1&loop=1&playlist=yihzD2UKNnA&controls=0&showinfo=0&rel=0&modestbranding=1",
